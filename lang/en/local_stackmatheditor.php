...
$string['setting_defaultgroups_help'] = 'Select which toolbar element groups should be available in the MathQuill editor for this question. Hold Ctrl (Cmd on Mac) to select multiple groups. Deselected groups will not appear in the student toolbar.';
