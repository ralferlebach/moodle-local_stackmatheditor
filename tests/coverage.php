...
/**
 * Coverage scope for local_stackmatheditor.
 *
 * Limited to the classes, which carry the behaviour worth measuring. Entry-point scripts
 * (configure.php, settings.php) are exercised by Behat rather than PHPUnit, so including
 * them would depress the figure without saying anything about test quality.
 *
...
/**
 * Coverage scope definition for local_stackmatheditor.
 *
 * @package    local_stackmatheditor
 * @copyright  2026 Ralf Erlebach
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
