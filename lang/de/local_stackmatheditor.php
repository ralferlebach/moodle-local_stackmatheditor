...
$string['setting_maxdimension'] = 'Maximale Matrix-/Vektordimension';
$string['setting_maxdimension_desc'] = 'Größte im Auswahl-Popup angebotene Anzahl von Zeilen, Spalten bzw. Vektorelementen. Standard ist 5; erlaubt sind Werte zwischen 2 und 20. Die Einstellung begrenzt nur die Auswahloberfläche – an STACK ändert sie nichts, und eine bereits vorhandene Antwort kürzt sie nicht. Test und Frage können einen eigenen Wert setzen; dort leer lassen heißt erben. Ohne die Gruppe Matrix oder Vektor bleibt die Einstellung wirkungslos.';
$string['setting_maxdimension_help'] = 'Größte im Auswahl-Popup angebotene Anzahl von Zeilen, Spalten bzw. Vektorelementen. Standard ist 5. Leer lassen, um den Wert der übergeordneten Ebene zu erben. Ohne die Gruppe Matrix oder Vektor bleibt die Einstellung wirkungslos.';
