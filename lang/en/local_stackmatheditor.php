...
$string['setting_usepercentpi'] = 'Use %%pi notation for π';
$string['setting_usepercentpi_desc'] = 'When enabled, the editor converts \\pi to %%pi (Maxima native). When disabled (default), \\pi is converted to pi, which is also valid in STACK.';
